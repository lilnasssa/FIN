...
class Config:
    ...
    GEMINI_MODEL: str = os.getenv("GEMINI_MODEL", "gpt-4o-mini").strip() or "gpt-4o-mini"
...
class GeminiService:
    """Обёртка над OpenAI API. Ключ — из OPENAI_API_KEY."""
    ...
    def __init__(self, api_key: str, model: str, max_tokens: int) -> None:
        ...
        self.model = "gpt-4o-mini" if requested.lower() == "auto" else requested
        self.max_tokens = max_tokens
        ACTIVE_MODEL[""] = self.model

    # Оставлено для совместимости с точкой вызова в main(): у OpenAI
