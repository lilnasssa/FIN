...
class Config:
    ...
    GEMINI_MODEL: str = os.getenv("GEMINI_MODEL", "claude-sonnet-5").strip() or "claude-sonnet-5"
...
class GeminiService:
    """Обёртка над aethercode.my (OpenAI-совместимый API). Ключ — из OPENAI_API_KEY."""
    ...
    def __init__(self, api_key: str, model: str, max_tokens: int) -> None:
        ...
        self.model = "claude-sonnet-5" if requested.lower() == "auto" else requested
